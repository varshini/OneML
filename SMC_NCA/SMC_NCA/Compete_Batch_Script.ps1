...
#Setup
$UsefulScriptsFile = "C:\Users\varamase\source\repos\OfficeDataScience\Common\UsefulScripts\ScopeSubmit2.ps1"  #$PSScriptRoot
...
$ScriptRootPath = "C:\Users\varamase\source\repos\OfficeDataScience\Projects\SMC_NCA\SMC_NCA\SMC_NCA\0-Compete.script"  #$PSScriptRoot
