# Featurize CSM - 2 features created for CSM - 1) Binary Assignment feature - 1/0  2) Months of Engagement, Tried No of engagements but did not help in performance
...
csm_fy <- read.csv("C:\\Users\\varamase\\Documents\\DataStreams\\ROIFY19\\Investments\\CSMFY20.csv")
